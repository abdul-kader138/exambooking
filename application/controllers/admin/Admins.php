...
class Admins extends MY_Controller {
	public function __construct(){
		...
		public function datatable_json(){				   					   
			$records = $this->admin_model->get_all_users();
			$data = array();
			$i = 0;
...
//					<a title="Delete" class="delete btn btn-sm btn-danger '.$disabled.'" data-href="'.base_url('admin/admins/del/'.$row['id']).'" data-toggle="modal" data-target="#confirm-delete"> <i class="material-icons">delete</i></a>
//					',
		...
		public function admin_edit($id = 0){
			if($this->input->post('submit')){
				...
				if ($this->form_validation->run() == FALSE) {
					...
					$data['user_groups'] = $this->admin_model->get_user_groups();
