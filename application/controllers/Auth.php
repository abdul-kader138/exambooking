...
class Auth extends CI_Controller {
		...
		if($this->input->post('submit')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($result){
                    ...
                    $data['subTitle'] = 'Login or register to use our online services.';
	...
	public function register(){
		if($this->input->post('submit')){
			...
			if ($this->form_validation->run() == FALSE) {
                            ...
                            $data['subTitle'] = 'Register to use our online services.';
                            $this->load->view('auth/header', $data);
    ...
    function accept_terms(){
            $this->form_validation->set_message('accept_terms', 'Please agree to the terms of usage');
            return FALSE;
    }
	...
	public function forgot_password(){
		if($this->input->post('submit')){
            ...
            $data['loginBtn'] = 'yes';
            $data['bodyClass'] = 'register-page forgot-page';
            $data['pageTitle'] = 'Forgot Password';
            $data['subTitle'] = 'Recover your forgot password.';
            $this->load->view('auth/header', $data); 
	...
	public function terms_conditions(){
            ...
            $data['subTitle'] = '';
            $this->load->view('auth/header', $data); 
			$this->load->view('auth/terms_conditions',$data);
            $this->load->view('auth/footer');
	}
