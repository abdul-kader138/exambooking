        ...
        foreach ($records['data'] as $row) {
            $data[] = array(
                ...
                '<a title="View" class="update btn btn-sm btn-info" href="' . base_url('user/exam_registration/view_exam/' . $row['id']) . '"> <i class="material-icons">visibility</i></a>
                 <a title="Edit" class="update btn btn-sm btn-primary" href="' . base_url('user/exam_registration/view_exam/' . $row['id']) . '"> <i class="material-icons">edit</i></a>&nbsp;
...
//        $data['time_venue'] =$this->exam_registrati/on_model->get_user_exam_details_by_id($exam_details->time_venue);
