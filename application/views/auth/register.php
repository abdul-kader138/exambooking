...
<div class="login-box">
    ...
    <div class="card regPage">
        <div class="body">
            <?php echo form_open(base_url('auth/register'), 'class="login-form" id="registration_form" name="registration_form"'); ?>
            ...
            <div class="form-group">
                <input type="checkbox" name="terms" id="terms" required class="filled-in chk-col-pink mdl-checkbox__input">
                <label for="terms">I read and agree to the <a href="/exambooking/auth/terms_conditions" target="_blank">Terms
                        & Conditions</a>.</label>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <input type="submit" name="submit" id="submit" class="btn btn-block btn-success waves-effect"
                           value="Register">
                </div>
            </div>
