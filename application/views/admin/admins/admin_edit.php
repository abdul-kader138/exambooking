        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <?php endif; ?>
                    <?php echo form_open(base_url('admin/admins/admin_edit/' . md5($user['id'])), 'class="form-horizontal"') ?>
                    <div class="row clearfix">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="mobile no" name="mobile no"
                                           value="<?= $user['mobile_no']; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="status">
                                        ...
                                        <option value="0" <?= ($user['is_active'] == 0) ? 'selected' : '' ?>>Deactive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" id="admin_type" name="admin_type">
                                        <option value="2" <?= ($user['admin_type'] == 2) ? 'selected' : '' ?> >Super
                                            Admin
                                        </option>
                                        <option value="3" <?= ($user['admin_type'] == 3) ? 'selected' : '' ?>>Branch
                                            Admin
                                        </option>
                                    </select>
                                </div>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function () {
        ...
        $branch = $('#branch').val();
        console.log($branch);
        if ($branch == '' || $branch == undefined || $branch == null) $('.no').slideUp();
