    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?= base_url('admin/grade_management/grade_management_add'); ?>" class="btn bg-deep-orange waves-effect pull-right"><i
                            class="material-icons">add_circle</i> ADD Grade</a>
            </div>
            <div class="body">
...
<script>
    ...
    $("#grade_management_list").addClass('active');
</script>
