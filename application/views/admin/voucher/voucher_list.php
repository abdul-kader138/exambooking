    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?= base_url('admin/voucher/voucher_add'); ?>" class="btn bg-deep-orange waves-effect pull-right"><i
                            class="material-icons">add_circle</i> ADD Voucher</a>
            </div>
            <div class="body">
...
<script type="text/javascript">
    ...
    var table = $('#na_datatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "<?=base_url('admin/voucher/datatable_json')?>",
        "order": [[1, 'asc']],
        "columnDefs": [
