    ...
    <div class="card">
      ...
      <div class="body">
        <div class="row clearfix">
          ...
          <?php endif; ?>
          <?php echo form_open(base_url('admin/voucher/voucher_edit/'.md5($voucher['id'])), 'class="form-horizontal"')?>
            <div class="row clearfix">
                ...
                <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="code" name="code" value="<?=$voucher['code']?>" required class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row clearfix">
                ...
                <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="fee" name="fee" value="<?=$voucher['fee']?>" required class="form-control">
                        </div>
                    </div>
                </div>
            </div>
