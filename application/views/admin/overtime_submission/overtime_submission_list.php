    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?= base_url('admin/overtime_submission/overtime_submission_add'); ?>" class="btn bg-deep-orange waves-effect pull-right"><i
                            class="material-icons">add_circle</i> ADD Overtime Code</a>
            </div>
            <div class="body">
...
<script type="text/javascript">
    ...
    var table = $('#na_datatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "<?=base_url('admin/overtime_submission/datatable_json')?>",
        "order": [[1, 'asc']],
        "columnDefs": [
            {"targets": 0, "name": "id", 'searchable': true, 'orderable': true},
            {"targets": 1, "name": "code", 'searchable': true, 'orderable': true},
            {"targets": 2, "name": "fee", 'searchable': true, 'orderable': true},
...
<script>
    ...
    $("overtime_submission_list").addClass('active');
</script>
