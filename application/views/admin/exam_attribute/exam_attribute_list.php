    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a href="<?= base_url('admin/exam_attribute/exam_attribute_add'); ?>" class="btn bg-deep-orange waves-effect pull-right"><i
                            class="material-icons">add_circle</i> ADD Attribute</a>
            </div>
            <div class="body">
...
<script type="text/javascript">
    ...
    var table = $('#na_datatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "<?=base_url('admin/exam_attribute/datatable_json')?>",
        "order": [[3, 'asc']],
        "columnDefs": [
...
<script>
    ...
    $("#exam_attribute_list").addClass('active');
</script>
