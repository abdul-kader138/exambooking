            ...
            <div class="body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="well well-sm">
                        <a href="<?php echo base_url('files/csv/sample_candidate_submission_update.csv'); ?>"
...
The correct column order is ( Ref No, ID, Exam No, Exam Date (Format- DD-MM-YY HH:MM (24 Hours Format)), Exam Status, Voucher Code ) & you must follow this.</span>
                        <br>
                        <br>
                        <br>
                        <div class="clearfix"></div>
                        <div>
                            <?php echo form_open_multipart('admin/exam_registration/update_candidates'); ?>
...
<script type="text/javascript">
    ...
    $("#update_candidates").addClass('active');
</script>